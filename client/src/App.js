          ...
          {data ? (
            <div className="app">
              ...
              <main className="content">
                {loginData ? (<><Topbar isNotifDrawerVisibile={isNotifDrawerVisibile} setIsNotifDrawerVisible={setIsNotifDrawerVisible} setIsSidebar={setIsSidebar} setData={setData} notificationData={notificationData} getNotifications={getNotifications} setSelected={setSelected} /></>) : (<></>)}
                <Routes>
